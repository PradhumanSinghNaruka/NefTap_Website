...
function Register() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post("https://api.neftap.com/register/register", userInfo)  // Check yeh URL backend ke hisaab se sahi hai
      .then((res) => {
  ...
  return (
    <>
      <div name="/registor98n76e54f32t10a98pNE98FT76AP54" className="text-black mt-20 h-full mb-8 md:mb-12">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-col md:flex-row text-center">
            <div className="md:w-full order-1 h-[600px] bg-blue-50 p-12 text center">
              <h1 className="md:mt-2 text-xl md:text-3xl font-semibold">
