...
//         <div name="/pvc" className="text-black mb-0 mt-24">
//           <div className="bg-blue-50">
//             <div className="bg-blue-50">
...
//                         Add To Cart
//                       </button>
//                       <button className="flex-1 p-2 bg-black text-white hover:bg-white hover:text-black border border-black duration-300 rounded-md text-sm font-bold" onClick={()=>navigate("/printing")}>
//                         Buy Now
//                       </button>
//                     </div>
//                   </div>
