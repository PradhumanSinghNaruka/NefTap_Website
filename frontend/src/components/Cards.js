            ...
            >
              <div className="flex flex-col md:flex-row cursor-pointer">
                <div className="md:w-3/4 space-y-4 order-2 md:order-1">
                  <h1 className="text-3xl">Metal</h1>
                  <h1 className="font-bold text-3xl">NFC Cards</h1>
                  <p>Make connection with these high-quality NFC visiting card and create a statement that's sure to impress!</p>
                  <button
                    className="p-3 bg-black text-white border font-bold rounded-md hover:bg-white hover:text-black hover:border-black duration-700"
                    onClick={() => navigate("/pvc")}
                  >
            ...
            >
              <div className="flex flex-col md:flex-row cursor-pointer">
                <div className="md:w-3/4 space-y-4 order-2 md:order-1">
                  <h1 className="text-3xl">Influencer</h1>
                  <h1 className="font-bold text-3xl">NFC Cards</h1>
                  <p>These smart business cards are made just for influencers to network with a dash of style cards!</p>
                  <button
                    className="p-3 bg-black text-white border font-bold rounded-md hover:bg-white hover:text-black hover:border-black duration-700"
                    onClick={() => navigate("/pvc")}
                  >
            ...
            >
              <div className="flex flex-col md:flex-row cursor-pointer">
                <div className="md:w-3/4 space-y-4 order-2 md:order-1">
                  <h1 className="text-3xl">PVC</h1>
                  <h1 className="font-bold text-3xl">NFC Cards</h1>
                  <p>PVC NFC cards by Rich Kardz is the perfect solution for a cheaper but durable business visiting card.</p>
                  <button
                    className="p-3 bg-black text-white border font-bold rounded-md hover:bg-white hover:text-black hover:border-black duration-700"
                    onClick={() => navigate("/pvc")}
                  >
            ...
            >
              <div className="flex flex-col md:flex-row cursor-pointer">
                <div className="md:w-3/4 space-y-4 order-2 md:order-1">
                  <h1 className="text-3xl">Engraved</h1>
                  <h1 className="font-bold text-3xl">NFC Cards</h1>
                  <p>Each engraved NFC based business card is a masterpiece, carefully engraved to reflect your unique style!</p>
                  <button
                    className="p-3 bg-black text-white border font-bold rounded-md hover:bg-white hover:text-black hover:border-black duration-700"
                    onClick={() => navigate("/pvc")}
                  >
