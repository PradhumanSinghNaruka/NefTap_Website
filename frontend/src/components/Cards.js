...
function Cards() {
  ...
  const items = [
    ...
    },
    {
      ...
      title1: "NFC Card",
      description:
        "PVC NFC cards by NefTap is the perfect solution for a cheaper but durable business visiting card.",
      image: photo2,
    },
    {
      id: 3,
      ...
      title1: "NFC Card",
      description:
        "These smart business cards are made just for influencers to network with a dash of style cards!",
      image: photo4,
    },
    {
      id: 4,
      ...
      title1: "NFC Card",
      description:
        "Each engraved NFC based business card is a masterpiece, carefully engraved to reflect your unique style!",
      image: photo1,
    },
  ];
  ...
  return (
    <>
      <div className="relative max-w-screen-xl mx-auto px-4 md:px-20 bg-white overflow-hidden">
        ...
        <marquee>
          <p className="text-2xl md:text-2xl lg:text-3xl font-bold text-black mt-6 z-20 relative">
            SMART, CLASSY, SECURE, SAFE, SMART, CLASSY, SECURE, SAFE, SMART,
            CLASSY, SECURE, SAFE
          </p>
        </marquee>
      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-20 bg-white mt-4">
        <div className="mt-4 p-3">
          <h1 className="font-bold mt-4 text-2xl md:text-4xl lg:text-5xl text-center flex flex-wrap justify-center gap-2">
            <span ref={leftRef} className="leading-tight bg-clip-text">
              Find the best digital
            </span>
            <span
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-4 px-6">
              {items.map((item) => (
                <div
                  ...
                  key={item.id}
                >
                  <div className="w-full grid md:grid lg:flex gap-3">
                    <div className="w-full md:w-full lg:w-[70%] space-y-2 order-2 md:order-1">
                    ...
                    <div className="w-full md:w-full lg:w-[30%] flex justify-center items-center order-1 md:order-2">
