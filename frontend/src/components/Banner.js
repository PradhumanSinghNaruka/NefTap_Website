...
function Banner() {
  const greenShadow = {
    boxShadow: "0 14px 16px hsla(240, 1.60%, 47.80%, 0.50)",
  };
      ...
      >
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 mt-12 md:mt-36 space-y-6 order-2 md:order-1 mb-20">
            ...
            <br />
            <button
              className="border rounded-md px-4 py-2 font-bold text-2xl bg-white text-black hover:bg-black duration-300 hover:text-white hover:border-white"
